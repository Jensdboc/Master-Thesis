...
class GIFDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        frames_tr = frames_tr.iloc[
            : AMOUNT_OF_FRAMES // self.skipframes: self.skipframes, :
        ]
...
def get_dataset(
    endpath: str = "split_keypoint", skipframes: int = 1, name=""
...
def train_and_plot(model: Any, parameters: Dict[str, Any], name: str) -> None:
    ...
    for epoch in range(num_epochs):
        ...
        plt.legend()
        plt.savefig(
            f"../images/trainandvalcurves_{name}.png"
        )
